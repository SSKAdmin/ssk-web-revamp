               ...
               {activeJobs.map((job: any) => (
                 <div key={job.id} className="bg-white border-2 border-ssk-border hover:border-ssk-cyan hover:shadow-ssk-glow p-10 flex flex-col justify-between transition-all group">
                   ...
                   <div className="pt-6 border-t border-ssk-border mt-auto flex justify-end items-center">
                     <Link href={`/${lang}/careers/${job.slug || job.id}`} className="group-hover:translate-x-2 transition-transform inline-flex items-center text-[12px] font-bold text-ssk-cyan uppercase tracking-[0.2em]">
